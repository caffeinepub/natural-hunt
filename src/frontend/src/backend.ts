...
export class Backend implements backendInterface {
    ...
    async addIdentification(arg0: PlantIdentification): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addIdentification(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDiscoveries(): Promise<Array<PlantIdentification>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiscoveries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSelectedCharFromCache(): Promise<AnimeCharacter | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSelectedCharFromCache();
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AnimeCharacter]): AnimeCharacter | null {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        discoveryCount: value.discoveryCount,
        points: value.points
    };
}
...
function to_candid_Identifier_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Identifier): _Identifier {
...
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        badge: value.badge,
        identifier: to_candid_Identifier_n20(_uploadFile, _downloadFile, value.identifier),
        discoveryCount: value.discoveryCount,
        points: value.points
    };
}
